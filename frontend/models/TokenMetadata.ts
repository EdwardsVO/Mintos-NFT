export default interface TokenMetada {
   ...
   media_hash?: Array<string>, // Base64-encoded sha256 hash of content referenced by the `media` field. Required if `media` is included.
   ...
   reference_hash?: Array<string>, // Base64-encoded sha256 hash of JSON from reference field. Required if `reference` is included.
}