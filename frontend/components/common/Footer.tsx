  ...
  return (
    <div className="w-full h-60 bg-figma-100 flex flex-row justify-evenly items-center relative">
      <div className="hidden lg:block w-80 h-full">
        <img className="hidden lg:block w-48 ml-10 pt-10 text-white " src="/logo.png" alt="logo" />
      </div>
      <div className="md:w-80 w-32 h-40 flex flex-col justify-center">
        ...
        <div className="flex flex-row items-center">
          ...
          <Link href="/">
            <p className="text-white md:text-base text-sm font-extralight md:ml-2 ml-1 cursor-pointer hover:underline">info@mintos.com</p>
          </Link>
        </div>
        <div className="flex flex-row items-center">
      ...
      <div className="md:w-80 w-32 h-40 flex flex-col justify-center">
        ...
        <Link href="/">
          <p className="text-white font-extralight cursor-pointer hover:underline md:text-base text-sm">Privacy Policy</p>
        </Link>
      </div>
      ...
      <div className="w-full h-full absolute flex items-end justify-end">
        <p className="text-white mb-5 text-xs mr-20">MintosNFT Marketplace 🚀 - Near Protocol 2022 Ⓝ</p>
      </div>
    </div>
  )
}