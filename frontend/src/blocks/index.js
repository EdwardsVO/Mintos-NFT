...
export default function getBlock({ theme = "blue", darkMode = false }) {
  return {
    Blog: {
      BlogA: darkMode ? (
        <DarkBlogA theme={theme} />
      ) : (
        <LightBlogA theme={theme} />
      ),
      BlogB: darkMode ? (
        <DarkBlogB theme={theme} />
      ) : (
        <LightBlogB theme={theme} />
      ),
      BlogC: darkMode ? (
        <DarkBlogC theme={theme} />
      ) : (
        <LightBlogC theme={theme} />
      ),
      BlogD: darkMode ? (
        <DarkBlogD theme={theme} />
      ) : (
        <LightBlogD theme={theme} />
      ),
      BlogE: darkMode ? (
        <DarkBlogE theme={theme} />
      ) : (
        <LightBlogE theme={theme} />
      ),
    },
    Contact: {
      ContactA: darkMode ? (
        <DarkContactA theme={theme} />
      ) : (
        <LightContactA theme={theme} />
      ),
      ContactB: darkMode ? (
        <DarkContactB theme={theme} />
      ) : (
        <LightContactB theme={theme} />
      ),
      ContactC: darkMode ? (
        <DarkContactC theme={theme} />
      ) : (
        <LightContactC theme={theme} />
      ),
    },
    Content: {
      ContentA: darkMode ? (
        <DarkContentA theme={theme} />
      ) : (
        <LightContentA theme={theme} />
      ),
      ContentB: darkMode ? (
        <DarkContentB theme={theme} />
      ) : (
        <LightContentB theme={theme} />
      ),
      ContentC: darkMode ? (
        <DarkContentC theme={theme} />
      ) : (
        <LightContentC theme={theme} />
      ),
      ContentD: darkMode ? (
        <DarkContentD theme={theme} />
      ) : (
        <LightContentD theme={theme} />
      ),
      ContentE: darkMode ? (
        <DarkContentE theme={theme} />
      ) : (
        <LightContentE theme={theme} />
      ),
      ContentF: darkMode ? (
        <DarkContentF theme={theme} />
      ) : (
        <LightContentF theme={theme} />
      ),
      ContentG: darkMode ? (
        <DarkContentG theme={theme} />
      ) : (
        <LightContentG theme={theme} />
      ),
      ContentH: darkMode ? (
        <DarkContentH theme={theme} />
      ) : (
        <LightContentH theme={theme} />
      ),
    },
    CTA: {
    ...
    Ecommerce: {
      EcommerceA: darkMode ? (
        <DarkEcommerceA theme={theme} />
      ) : (
        <LightEcommerceA theme={theme} />
      ),
      EcommerceB: darkMode ? (
        <DarkEcommerceB theme={theme} />
      ) : (
        <LightEcommerceB theme={theme} />
      ),
      EcommerceC: darkMode ? (
        <DarkEcommerceC theme={theme} />
      ) : (
        <LightEcommerceC theme={theme} />
      ),
    },
    Feature: {
      FeatureA: darkMode ? (
        <DarkFeatureA theme={theme} />
      ) : (
        <LightFeatureA theme={theme} />
      ),
      FeatureB: darkMode ? (
        <DarkFeatureB theme={theme} />
      ) : (
        <LightFeatureB theme={theme} />
      ),
      FeatureC: darkMode ? (
        <DarkFeatureC theme={theme} />
      ) : (
        <LightFeatureC theme={theme} />
      ),
      FeatureD: darkMode ? (
        <DarkFeatureD theme={theme} />
      ) : (
        <LightFeatureD theme={theme} />
      ),
      FeatureE: darkMode ? (
        <DarkFeatureE theme={theme} />
      ) : (
        <LightFeatureE theme={theme} />
      ),
      FeatureF: darkMode ? (
        <DarkFeatureF theme={theme} />
      ) : (
        <LightFeatureF theme={theme} />
      ),
      FeatureG: darkMode ? (
        <DarkFeatureG theme={theme} />
      ) : (
        <LightFeatureG theme={theme} />
      ),
      FeatureH: darkMode ? (
        <DarkFeatureH theme={theme} />
      ) : (
        <LightFeatureH theme={theme} />
      ),
    },
    Footer: {
      FooterA: darkMode ? (
        <DarkFooterA theme={theme} />
      ) : (
        <LightFooterA theme={theme} />
      ),
      FooterB: darkMode ? (
        <DarkFooterB theme={theme} />
      ) : (
        <LightFooterB theme={theme} />
      ),
      FooterC: darkMode ? (
        <DarkFooterC theme={theme} />
      ) : (
        <LightFooterC theme={theme} />
      ),
      FooterD: darkMode ? (
        <DarkFooterD theme={theme} />
      ) : (
        <LightFooterD theme={theme} />
      ),
      FooterE: darkMode ? (
        <DarkFooterE theme={theme} />
      ) : (
        <LightFooterE theme={theme} />
      ),
    },
    Gallery: {
      GalleryA: darkMode ? (
        <DarkGalleryA theme={theme} />
      ) : (
        <LightGalleryA theme={theme} />
      ),
      GalleryB: darkMode ? (
        <DarkGalleryB theme={theme} />
      ) : (
        <LightGalleryB theme={theme} />
      ),
      GalleryC: darkMode ? (
        <DarkGalleryC theme={theme} />
      ) : (
        <LightGalleryC theme={theme} />
      ),
    },
    Header: {
      HeaderA: darkMode ? (
        <DarkHeaderA theme={theme} />
      ) : (
        <LightHeaderA theme={theme} />
      ),
      HeaderB: darkMode ? (
        <DarkHeaderB theme={theme} />
      ) : (
        <LightHeaderB theme={theme} />
      ),
      HeaderC: darkMode ? (
        <DarkHeaderC theme={theme} />
      ) : (
        <LightHeaderC theme={theme} />
      ),
      HeaderD: darkMode ? (
        <DarkHeaderD theme={theme} />
      ) : (
        <LightHeaderD theme={theme} />
      ),
    },
    Hero: {
      HeroA: darkMode ? (
        <DarkHeroA theme={theme} />
      ) : (
        <LightHeroA theme={theme} />
      ),
      HeroB: darkMode ? (
        <DarkHeroB theme={theme} />
      ) : (
        <LightHeroB theme={theme} />
      ),
      HeroC: darkMode ? (
        <DarkHeroC theme={theme} />
      ) : (
        <LightHeroC theme={theme} />
      ),
      HeroD: darkMode ? (
        <DarkHeroD theme={theme} />
      ) : (
        <LightHeroD theme={theme} />
      ),
      HeroE: darkMode ? (
        <DarkHeroE theme={theme} />
      ) : (
        <LightHeroE theme={theme} />
      ),
      HeroF: darkMode ? (
        <DarkHeroF theme={theme} />
      ) : (
        <LightHeroF theme={theme} />
      ),
    },
    Pricing: {
      PricingA: darkMode ? (
        <DarkPricingA theme={theme} />
      ) : (
        <LightPricingA theme={theme} />
      ),
      PricingB: darkMode ? (
        <DarkPricingB theme={theme} />
      ) : (
        <LightPricingB theme={theme} />
      ),
    },
    Statistic: {
      StatisticA: darkMode ? (
        <DarkStatisticA theme={theme} />
      ) : (
        <LightStatisticA theme={theme} />
      ),
      StatisticB: darkMode ? (
        <DarkStatisticB theme={theme} />
      ) : (
        <LightStatisticB theme={theme} />
      ),
      StatisticC: darkMode ? (
        <DarkStatisticC theme={theme} />
      ) : (
        <LightStatisticC theme={theme} />
      ),
    },
    Step: {
      StepA: darkMode ? (
        <DarkStepA theme={theme} />
      ) : (
        <LightStepA theme={theme} />
      ),
      StepB: darkMode ? (
        <DarkStepB theme={theme} />
      ) : (
        <LightStepB theme={theme} />
      ),
      StepC: darkMode ? (
        <DarkStepC theme={theme} />
      ) : (
        <LightStepC theme={theme} />
      ),
    },
    Team: {
      TeamA: darkMode ? (
        <DarkTeamA theme={theme} />
      ) : (
        <LightTeamA theme={theme} />
      ),
      TeamB: darkMode ? (
        <DarkTeamB theme={theme} />
      ) : (
        <LightTeamB theme={theme} />
      ),
      TeamC: darkMode ? (
        <DarkTeamC theme={theme} />
      ) : (
        <LightTeamC theme={theme} />
      ),
    },
    Testimonial: {
      TestimonialA: darkMode ? (
        <DarkTestimonialA theme={theme} />
      ) : (
        <LightTestimonialA theme={theme} />
      ),
      TestimonialB: darkMode ? (
        <DarkTestimonialB theme={theme} />
      ) : (
        <LightTestimonialB theme={theme} />
      ),
      TestimonialC: darkMode ? (
        <DarkTestimonialC theme={theme} />
      ) : (
        <LightTestimonialC theme={theme} />
      ),
    },
  };
}
